...
int main()
{
    ...
    cout << "------------------------------" << endl;
    cout << "No. of lattice cells in each direction" << endl;
    cout << "nX = " << nX << endl;
    cout << "nY = " << nY << endl;
    cout << "nZ = " << nZ << endl;
    ...
    cout << "and change of box co-ordinates" << endl;
    cout << "xLo = " << xLo << endl;
    cout << "xHi = " << xHi << endl;
    cout << "yLo = " << yLo << endl;
    cout << "yHi = " << yHi << endl;
    ...
    cout << "------------------------------------" << endl
         << "No. of lattice cells in each direction" << endl
         << "nPx = " << nPx << endl
         << "nPy = " << nPy << endl
         << "nPz = " << nPz << endl;
    ...
    writer << "3 " << mW << endl;   // constrained wall
    writer << endl;
    writer << "Atoms" << endl;
    writer << endl;
