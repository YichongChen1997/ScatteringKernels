...
int main()
{
    ...
    double mi = 6.6254E-26;  // molecular mass of Argon
    ...
    double Msigma = 3.35;   
    double Mdiameter = 3.35; // diameter of Argon
    ...
    double thickness = 20;  // thickness of the wall
    ...
    writer << "Masses" << endl;
    writer << endl;
    writer << "1   39.948" << endl;    //Argon -- Helium
