...
int main()
{
    ...
    double mi = 3.347646E-27;  // molecular mass of hydrogen molecule
    ...
    double Msigma = 2.81;  
    double Mdiameter = 2.81; // diameter of Helium

    srand(time(NULL));

    //**** THINGS TO CHANGE *****

    double rCut = 12; // gas-wall interaction distance
    ...
    writer << "Masses" << endl;
    writer << endl;
    writer << "1   2.01599" << endl;   //Hydrogen -- H2
    ...
    cout << "Number of hydrogen molecules placed = " << mol << endl;
