...
int main()
{
    ...
    double mi = 6.6465E-27;  // molecular mass of helium
    ...
    double Msigma = 2.64;   
    double Mdiameter = 2.64; // diameter of Helium
    ...
    double thickness =   8;  // thickness of the wall
    double zRigidRange = 10; // rigid bound of the wall
    ...
    writer << "Masses" << endl;
    writer << endl;
    writer << "1   4.002602" << endl;  //He -- Helium
    writer << "2   196.96" << endl;    //wall bottom
    writer << "3   196.96" << endl;    //wall top
    writer << "4   196.96" << endl;    //constrained wall
    writer << endl;
    writer << "Atoms" << endl;
    writer << endl;
