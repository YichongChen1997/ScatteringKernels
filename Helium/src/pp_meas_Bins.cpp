...
int main()
{
        ...
        for (n = 0; n < nAtoms; n++)
        {
            if (t >= skipTimeStep)
            {
                ...
                if ((z >= zLo) && (z <= zHi))
                {
                    ...
                    molField[bz] += 1.0;
                    keField[bz] += Mass * (vx * vx + vy * vy + vz * vz - velFieldTemp[bz] * velFieldTemp[bz]);
                    ...
                    molField2[bz2] += 1.0;
                    keField2[bz2] += Mass * (vx * vx + vy * vy + vz * vz - velFieldTemp2[bz2] * velFieldTemp2[bz2]);
...

    {
        ...
        for (i = 0; i < nBins; i++)
        {
            ...
            rho = molField[i] * Mass / (binVol * nAvSteps); // average density of each bin over time
...

    {
        ...
        for (i = 0; i < nBins2; i++)
        {
            ...
            rho = molField2[i] * Mass / (binVol2 * nAvSteps);
